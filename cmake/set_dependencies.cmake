...
if(NOT pybind11_POPULATED)
  ...
  target_link_libraries(pybind11 INTERFACE python_headers)
endif()
...
\"${LIBQI_GIT_TAG}\"")
  ...
  set(_libqi_package_xml_file ${libqi_SOURCE_DIR}/package.xml)
  file(STRINGS ${_libqi_package_xml_file} _libqi_package_xml_strings REGEX version)
  if(_libqi_package_xml_strings MATCHES [[version="([^"]*)"]])
    set(_libqi_package_version ${CMAKE_MATCH_1})
    message(STATUS "libqi: found version \"${_libqi_package_version}\"")
    if(LIBQI_VERSION AND NOT (LIBQI_VERSION VERSION_EQUAL _libqi_package_version))
      message(FATAL_ERROR "Version of LibQi mismatch (expected \
\"${LIBQI_VERSION}\", found \"${_libqi_package_version}\")")
    endif()
  else()
...
${_libqi_package_xml_file}. Please check that the file contains a version \
attribute.")
  endif()
